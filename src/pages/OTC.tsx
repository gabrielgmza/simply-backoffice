...
export default function OTC() {
  ...
  const loadData = async () => {
    try {
      ...
      const res = await api.get('/backoffice/otc/operations', { params });
      if (res.data.success) {
  ...
  const loadRates = async () => {
    try {
      const res = await api.get('/backoffice/otc/rates');
  ...
  const loadStats = async () => {
    try {
      const res = await api.get('/backoffice/otc/stats');
  ...
  const getQuote = async () => {
    ...
    try {
      const res = await api.post('/backoffice/otc/quote', {
        asset: formAsset,
        type: formType,
  ...
  const handleCreate = async () => {
    ...
    try {
      await api.post('/backoffice/otc/operations', {
        userId: formUserId,
        type: formType,
        asset: formAsset,
        amount: parseFloat(formAmount),
