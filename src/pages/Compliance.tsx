...
export default function Compliance() {
  ...
  const loadData = async () => {
    try {
      ...
      const res = await api.get('/backoffice/compliance/reports', { params });
      if (res.data.success) {
  ...
  const loadStats = async () => {
    try {
      const res = await api.get('/backoffice/compliance/stats');
  ...
  const loadThresholds = async () => {
    try {
      const res = await api.get('/backoffice/compliance/thresholds');
  ...
  const loadPendingReviews = async () => {
    try {
      const res = await api.get('/backoffice/compliance/reviews/pending');
  ...
  const handleCreateROS = async () => {
    try {
      await api.post('/backoffice/compliance/reports/ros', {
        userId: formUserId,
