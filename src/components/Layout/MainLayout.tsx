...
const menuItems = [
  ...
  { text: 'Tesorería', icon: <TreasuryIcon />, path: '/treasury', permission: 'treasury:read' },
  { text: 'OTC', icon: <OTCIcon />, path: '/otc', permission: 'otc:read' },
  { divider: true, text: 'divider2' },
  { text: 'Fraude', icon: <FraudIcon />, path: '/fraud', permission: 'fraud:read' },
  { text: 'Compliance', icon: <ComplianceIcon />, path: '/compliance', permission: 'compliance:read' },
...
export default function MainLayout() {
  ...
  const filteredMenuItems = menuItems.filter(
    (item) => ('divider' in item && item.divider) || !item.permission || hasPermission(item.permission)
  );
