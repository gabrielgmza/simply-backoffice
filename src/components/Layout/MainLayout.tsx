...
export default function MainLayout() {
  ...
  const menuSections = [
    ...
    { title: 'Soporte & AI', collapsible: true, open: supportOpen, toggle: () => setSupportOpen(!supportOpen), items: [
      ...
      { text: 'Aria AI', icon: <SmartToy />, path: '/aria', permission: 'aria:use' },
    ]},
    { title: 'Marketing & Comms', items: [
      { text: 'Marketing', icon: <TrendingUp />, path: '/marketing', permission: 'marketing:read' },
      { text: 'Buzón Correo', icon: <Notifications />, path: '/mailbox', permission: null },
    ]},
      { text: 'Marketing', icon: <Dashboard />, path: '/marketing', permission: 'marketing:read' },
      { text: 'Buzón', icon: <Notifications />, path: '/mailbox', permission: null },
    ]},
  ];
